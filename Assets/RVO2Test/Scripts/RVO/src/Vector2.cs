...
//         {
//             return new float2(vector.x * scalar, vector.y * scalar);
//         }
...
//          * <param name="vector2">The second two-dimensional vector.</param>
//          */
//         public static float2 operator +(float2 vector1, float2 vector2)
//         {
//             return new float2(vector1.x + vector2.x, vector1.y + vector2.y);
//         }

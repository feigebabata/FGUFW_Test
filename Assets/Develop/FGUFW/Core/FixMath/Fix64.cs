...
namespace FGUFW 
{
    ...
    /// </summary>
    [Serializable]
    public partial struct V1 : IEquatable<V1>, IComparable<V1> 
    {
        [SerializeField]
        ...
        public static readonly decimal Precision = (decimal)(new V1(1L));//0.00000000023283064365386962890625m;
        public static readonly V1 MaxValue = new V1(MAX_VALUE-1);
        public static readonly V1 MinValue = new V1(MIN_VALUE+2);
        public static readonly V1 One = new V1(ONE);
		public static readonly V1 Ten = new V1(TEN);
        public static readonly V1 Half = new V1(HALF);

        public static readonly V1 Zero = new V1();
        public static readonly V1 PositiveInfinity = new V1(MAX_VALUE);
        public static readonly V1 NegativeInfinity = new V1(MIN_VALUE+1);
        public static readonly V1 NaN = new V1(MIN_VALUE);

        public static readonly V1 EN1 = V1.One / 10;
        public static readonly V1 EN2 = V1.One / 100;
        public static readonly V1 EN3 = V1.One / 1000;
        public static readonly V1 EN4 = V1.One / 10000;
        public static readonly V1 EN5 = V1.One / 100000;
        public static readonly V1 EN6 = V1.One / 1000000;
        public static readonly V1 EN7 = V1.One / 10000000;
        public static readonly V1 EN8 = V1.One / 100000000;
        public static readonly V1 Epsilon = V1.EN3;

        /// <summary>
        /// The value of Pi
        /// </summary>
        public static readonly V1 Pi = new V1(PI);
        public static readonly V1 PiOver2 = new V1(PI_OVER_2);
        public static readonly V1 PiTimes2 = new V1(PI_TIMES_2);
        public static readonly V1 PiInv = (V1)0.3183098861837906715377675267M;
        public static readonly V1 PiOver2Inv = (V1)0.6366197723675813430755350535M;

        public static readonly V1 Deg2Rad = Pi / new V1(180);

        public static readonly V1 Rad2Deg = new V1(180) / Pi;

		public static readonly V1 LutInterval = (V1)(LUT_SIZE - 1) / PiOver2;

        public static readonly V1 Log2Max = new V1(LOG2MAX);
        public static readonly V1 Log2Min = new V1(LOG2MIN);
        public static readonly V1 Ln2 = new V1(LN2);
        ...
        /// </summary>
        public static V1 FastAbs(V1 value) {
            // branchless implementation, see http://www.strchr.com/optimized_abs_function
            var mask = value._serializedValue >> 63;
            V1 result;
            result._serializedValue = (value._serializedValue + mask) ^ mask;
        ...
        /// </summary>
        public static V1 operator +(V1 x, V1 y) {
            V1 result;
        ...
        /// </summary>
        public static V1 OverflowAdd(V1 x, V1 y) {
        ...
        /// </summary>
        public static V1 FastAdd(V1 x, V1 y) {
            V1 result;
            result._serializedValue = x._serializedValue + y._serializedValue;
            return result;
            //return new FP(x._serializedValue + y._serializedValue);
        ...
        /// </summary>
        public static V1 OverflowSub(V1 x, V1 y) {
            var xl = x._serializedValue;
            var yl = y._serializedValue;
            var diff = xl - yl;
        ...
        /// Subtracts y from x witout performing overflow checking. Should be inlined by the CLR.
        /// </summary>
        public static V1 FastSub(V1 x, V1 y) {
            return new V1(x._serializedValue - y._serializedValue);
        }
        ...
        /// </summary>
        public static V1 OverflowMul(V1 x, V1 y) {
            var xl = x._serializedValue;
            var yl = y._serializedValue;
        ...
        /// Useful for performance-critical code where the values are guaranteed not to cause overflow
        /// </summary>
        public static V1 FastMul(V1 x, V1 y) {
            var xl = x._serializedValue;
            var yl = y._serializedValue;
        ...
        /// </summary>
        public static V1 FastMod(V1 x, V1 y) {
            V1 result;
            result._serializedValue = x._serializedValue % y._serializedValue;
            return result;
            //return new FP(x._serializedValue % y._serializedValue);
        ...
        public static V1 operator -(V1 x) {
            return x._serializedValue == MIN_VALUE ? MaxValue : new V1(-x._serializedValue);
        }

        public static bool operator ==(V1 x, V1 y) {
        ...
        public static V1 Sin(V1 x) {
            ...
            var nearestValue = new V1(SinLut[flipHorizontal ?
                SinLut.Length - 1 - (int)roundedIndex :
                (int)roundedIndex]);
            var secondNearestValue = new V1(SinLut[flipHorizontal ?
        ...
        /// </summary>
        public static V1 Cos(V1 x) {
            var xl = x._serializedValue;
            var rawAngle = xl + (xl > 0 ? -PI - PI_OVER_2 : PI_OVER_2);
            V1 a2 = Sin(new V1(rawAngle));
            return a2;
        }
        ...
        /// </summary>
        public static V1 FastCos(V1 x) {
            var xl = x._serializedValue;
            var rawAngle = xl + (xl > 0 ? -PI - PI_OVER_2 : PI_OVER_2);
            return FastSin(new V1(rawAngle));
        }
        ...
        public static V1 Tan(V1 x) {
            ...
            var nearestValue = new V1(TanLut[(int)roundedIndex]);
            var secondNearestValue = new V1(TanLut[(int)roundedIndex + Sign(indexError)]);

            var delta = FastMul(indexError, FastAbs(FastSub(nearestValue, secondNearestValue)))._serializedValue;
            var interpolatedValue = nearestValue._serializedValue + delta;
            var finalValue = flip ? -interpolatedValue : interpolatedValue;
            V1 a2 = new V1(finalValue);
            return a2;
        }
        ...
        public static implicit operator V1(long value) {
            V1 result;
        ...
        public static explicit operator long(V1 value) {
            return value._serializedValue >> FRACTIONAL_PLACES;
        }

        public static implicit operator V1(float value) {
            V1 result;
        ...
        public static explicit operator float(V1 value) {
            return (float)value._serializedValue / ONE;
        }

        public static implicit operator V1(double value) {
            V1 result;
            result._serializedValue = (long)(value * ONE);
            return result;
            //return new FP((long)(value * ONE));
        ...
        public static explicit operator double(V1 value) {
            return (double)value._serializedValue / ONE;
        }

        public static explicit operator V1(decimal value) {
            V1 result;
            result._serializedValue = (long)(value * ONE);
            return result;
            //return new FP((long)(value * ONE));
        ...
        public static implicit operator V1(int value) {
            V1 result;
            result._serializedValue = value * ONE;
            return result;
            //return new FP(value * ONE);
        ...
        public static explicit operator decimal(V1 value) {
        ...
        public static float ToFloat(V1 value) {
            return (float)value;
        }

        public static int ToInt(V1 value) {
            return (int)value;
        }

        public static V1 FromFloat(float value) {
            return (V1)value;
        }

        public static bool IsInfinity(V1 value) {
            return value == NegativeInfinity || value == PositiveInfinity;
        }

        public static bool IsNaN(V1 value) {
            return value == NaN;
        }

        public override bool Equals(object obj) {
            return obj is V1 && ((V1)obj)._serializedValue == _serializedValue;
        }
        ...
        public static V1 FromRaw(long rawValue) {
            return new V1(rawValue);
        }
    ...
    partial struct FP {
        public static readonly long[] AcosLut = new[] {");
                ...
                for (int i = 0; i < LUT_SIZE; ++i) {
                    ...
                    var rawValue = ((V1)acos)._serializedValue;
    ...
    partial struct Fix64 {
        public static readonly long[] SinLut = new[] {");
                ...
                for (int i = 0; i < LUT_SIZE; ++i) {
                    ...
                    var rawValue = ((V1)sin)._serializedValue;
                    writer.Write(string.Format("0x{0:X}L, ", rawValue));
                }
                writer.Write(
@"
    ...
    partial struct Fix64 {
        public static readonly long[] TanLut = new[] {");
                ...
                for (int i = 0; i < LUT_SIZE; ++i) {
                    ...
                    var rawValue = (((decimal)tan > (decimal)MaxValue || tan < 0.0) ? MaxValue : (V1)tan)._serializedValue;
                    writer.Write(string.Format("0x{0:X}L, ", rawValue));
                }
                writer.Write(
@"

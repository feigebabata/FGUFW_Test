...
namespace FGUFW {
    ...
    public class FixRandom {
         ...
         **/
        public V1 Next(float minValue, float maxValue) {
            ...
            return (V1.Floor((maxValueInt - minValueInt + 1) * NextFP() +
                minValueInt)) / 1000;
        }
         ...
         *  @brief Returns a {@link FP} between a min value [inclusive] and a max value [inclusive].
         **/
        public static V1 Range(float minValue, float maxValue) {
            return instance.Next(minValue, maxValue);
        }
         ...
         **/
        public V1 NextFP() {
            return ((V1) Next()) / (MaxRandomInt);
        }

        /**
         *  @brief Returns a {@link FP} between 0.0 [inclusive] and 1.0 [inclusive].
         **/
        public static V1 value {
            get {
         ...
         **/
        public static V3 insideUnitSphere {
            get {
                return new V3(value, value, value);
            }
        }
        ...
        V1 genrand_FP() {
            return (V1)genrand_int32() * (V1.One / (V1)4294967295);
        }

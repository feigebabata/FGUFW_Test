...
namespace FGUFW.BehaviorTree.Editor
{
    public class NodeView : Node
    {
        ...
        public NodeView(BehaviorTreeNodeBase node)
        {
            ...
            this.mainContainer.style.backgroundColor = new Color(0.3f,0.3f,0.3f,1f);
            this.titleContainer.style.color = Color.white;
            this.title = "测试标题";
        ...
        {
            // if(node is IBehaviorTreeNodeUpdateProgress)
            // {
                ...
                this.mainContainer.Insert(0,progressBar);
                // this.topContainer.Add(progressBar);
                // this.mainContainer.Add(progressBar);
                // this.titleContainer.Add(progressBar);
                // this.extensionContainer.Add(progressBar);
                // this.titleButtonContainer.Add(progressBar);
                // this.Insert(0,progressBar);
